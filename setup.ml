...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25ec9b93d8c913ba99ecf58cec1b1a9d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/DefinitelyMaybeTyped";
          synopsis = "Convert Typescript definitions to OCaml";
          description =
            Some [OASISText.Para "Convert Typescript definitions to OCaml"];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("mparser.pcre", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "otypescript";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "DefinitelyMaybeTyped"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "otypescript.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/DefinitelyMaybeTyped.git";
                      src_repo_browser =
                        Some
                          "https://github.com/ujamjar/DefinitelyMaybeTyped";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "U}5\246\2488\207\220\153\205m\165gd\006Q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
